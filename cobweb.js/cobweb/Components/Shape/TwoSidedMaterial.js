	...
	with (Fields)
	{
		...
		TwoSidedMaterial .prototype = $.extend (Object .create (X3DMaterialNode .prototype),
		{
			...
			fieldDefinitions: new FieldDefinitionArray ([
				...
				new X3DFieldDefinition (X3DConstants .inputOutput, "backSpecularColor",    new SFColor ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "backEmissiveColor",    new SFColor ()),
