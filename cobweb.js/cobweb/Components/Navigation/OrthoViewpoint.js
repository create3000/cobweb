	...
	with (Fields)
	{
		...
		OrthoViewpoint .prototype = $.extend (Object .create (X3DViewpointNode .prototype),
		{
			...
			fieldDefinitions: new FieldDefinitionArray ([
				...
				new X3DFieldDefinition (X3DConstants .inputOutput, "orientation",       new SFRotation ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "centerOfRotation",  new SFVec3f ()),
