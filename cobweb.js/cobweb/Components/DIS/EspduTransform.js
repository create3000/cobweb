	...
	with (Fields)
	{
		...
		EspduTransform .prototype = $.extend (Object .create (X3DGroupingNode .prototype),new X3DSensorNode (),
		{
			...
			fieldDefinitions: new FieldDefinitionArray ([
				...
				new X3DFieldDefinition (X3DConstants .inputOutput,    "detonationLocation",                         new SFVec3f ()),
				new X3DFieldDefinition (X3DConstants .inputOutput,    "detonationRelativeLocation",                 new SFVec3f ()),
				...
				new X3DFieldDefinition (X3DConstants .inputOutput,    "fired1",                                     new SFBool ()),
				new X3DFieldDefinition (X3DConstants .inputOutput,    "fired2",                                     new SFBool ()),
				...
				new X3DFieldDefinition (X3DConstants .inputOutput,    "linearVelocity",                             new SFVec3f ()),
				new X3DFieldDefinition (X3DConstants .inputOutput,    "linearAcceleration",                         new SFVec3f ()),
				...
				new X3DFieldDefinition (X3DConstants .inputOutput,    "munitionEndPoint",                           new SFVec3f ()),
				...
				new X3DFieldDefinition (X3DConstants .inputOutput,    "munitionStartPoint",                         new SFVec3f ()),
				...
				new X3DFieldDefinition (X3DConstants .initializeOnly, "rtpHeaderExpected",                          new SFBool ()),
			]),
