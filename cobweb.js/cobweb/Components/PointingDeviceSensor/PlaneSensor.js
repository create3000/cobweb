	...
	with (Fields)
	{
		...
		PlaneSensor .prototype = $.extend (Object .create (X3DDragSensorNode .prototype),
		{
			...
			fieldDefinitions: new FieldDefinitionArray ([
				...
				new X3DFieldDefinition (X3DConstants .inputOutput, "axisRotation",        new SFRotation ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "autoOffset",          new SFBool (true)),
				new X3DFieldDefinition (X3DConstants .inputOutput, "offset",              new SFVec3f ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "minPosition",         new SFVec2f ()),
