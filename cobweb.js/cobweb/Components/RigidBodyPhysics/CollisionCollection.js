	...
	with (Fields)
	{
		...
		CollisionCollection .prototype = $.extend (Object .create (X3DChildNode .prototype),
		{
			...
			fieldDefinitions: new FieldDefinitionArray ([
				...
				new X3DFieldDefinition (X3DConstants .inputOutput, "enabled",                  new SFBool ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "frictionCoefficients",     new SFVec2f ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "minBounceSpeed",           new SFFloat ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "slipFactors",              new SFVec2f ()),
				...
				new X3DFieldDefinition (X3DConstants .inputOutput, "surfaceSpeed",             new SFVec2f ()),
			]),
