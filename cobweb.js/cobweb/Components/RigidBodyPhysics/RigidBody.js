	...
	with (Fields)
	{
		...
		RigidBody .prototype = $.extend (Object .create (X3DNode .prototype),
		{
			...
			fieldDefinitions: new FieldDefinitionArray ([
				...
				new X3DFieldDefinition (X3DConstants .inputOutput, "angularVelocity",      new SFVec3f ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "autoDamp",             new SFBool ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "autoDisable",          new SFBool ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "centerOfMass",         new SFVec3f ()),
				...
				new X3DFieldDefinition (X3DConstants .inputOutput, "finiteRotationAxis",   new SFVec3f ()),
				new X3DFieldDefinition (X3DConstants .inputOutput, "fixed",                new SFBool ()),
