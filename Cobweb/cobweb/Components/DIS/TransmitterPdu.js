          ...
          X3DConstants)
{
	with (Fields)
	{
		...
		TransmitterPdu .prototype = $.extend (new X3DSensorNode (),new X3DBoundedObject (),
		{
			...
			fieldDefinitions: new FieldDefinitionArray ([
				...
				new X3DFieldDefinition (X3DConstants .inputOutput,    "antennaLocation",                    new SFVec3f (0, 0, 0)),
				...
				new X3DFieldDefinition (X3DConstants .inputOutput,    "relativeAntennaLocation",            new SFVec3f (0, 0, 0)),
				new X3DFieldDefinition (X3DConstants .inputOutput,    "rtpHeaderExpected",                  new SFBool (false)),
