...
function (Vector2, Vector3, Matrix3, eigendecomposition)
{
	...
	Matrix3 .prototype =
	{
		...
		set: function (translation, rotation, scale, scaleOrientation, center)
		{
			if (arguments .length)
			{
				if (translation === null)      translation      = new Vector2 (0, 0);
				if (rotation === null)         rotation         = new Vector3 (0, 0, 0);
				if (scale === null)            scale            = new Vector2 (1, 1);
				if (scaleOrientation === null) scaleOrientation = new Vector3 (0, 0, 0);
				if (center === null)           center           = new Vector2 (0, 0);
				...
				switch (arguments .length)
				{
					...
					case 5:
					{
						...
						var hasCenter = ! center .equals (new Vector2 (0, 0));
...
function ($, Matrix3, Vector2, Vector3, X3DField, X3DConstants)
{
	...
	SFMatrix3 .prototype = $.extend (new X3DField (),
	{
		...
		{
			translation      = translation      ? translation      .getValue () : new Vector2 (0, 0);
			rotation         = rotation         ? rotation         .getValue () : new Vector3 (0, 0, 0);
			scale            = scale            ? scale            .getValue () : new Vector2 (1, 1);
			scaleOrientation = scaleOrientation ? scaleOrientation .getValue () : new Vector3 (0, 0, 0);
			center           = center           ? center           .getValue () : new Vector2 (0, 0);
...
function (Vector3, Vector4, Rotation4, Matrix3, eigendecomosition)
{
	...
	Matrix4 .prototype =
	{
		...
		set: function (translation, rotation, scale, scaleOrientation, center)
		{
			if (arguments .length)
			{
				if (translation === null)      translation      = new Vector3 (0, 0, 0);
				...
				if (center === null)           center           = new Vector3 (0, 0, 0);
				...
				switch (arguments .length)
				{
					...
					case 5:
					{
						...
						var hasCenter = ! center .equals (new Vector3 (0, 0, 0));
...
function ($, Matrix4, Vector3, Rotation4, X3DField, X3DConstants)
{
	...
	SFMatrix4 .prototype = $.extend (new X3DField (),
	{
		...
		setTransform: function (translation, rotation, scale, scaleOrientation, center)
		{
			translation      = translation      ? translation      .getValue () : new Vector3 (0, 0, 0);
			...
			center           = center           ? center           .getValue () : new Vector3 (0, 0, 0);
...
define ('cobweb/Basic/FieldDefinitionArray',['require','exports','module'],function ($, X3DField, X3DConstants)
{
	var handler =
	{
		get: function (target, key)
...
define ('jquery-plugin/jquery.ba-resize.min',["jquery"],
function ($)
{
/*
...
function ($, Fields)
{
	with (Fields)
	{
		...
		var Grammar =
		{
			...
			// Values
			hex:    new RegExp("^(0[xX][\\da-fA-F]+)", "y"),
			int32:  new RegExp("^([+-]?(?:\\d+))", "y"),
