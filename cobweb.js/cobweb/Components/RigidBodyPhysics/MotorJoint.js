	...
	with (Fields)
	{
		...
		MotorJoint .prototype = $.extend (Object .create (X3DRigidJointNode .prototype),
		{
			...
			fieldDefinitions: new FieldDefinitionArray ([
				...
				new X3DFieldDefinition (X3DConstants .inputOutput,    "motor1Axis",           new SFVec3f ()),
				new X3DFieldDefinition (X3DConstants .inputOutput,    "motor2Axis",           new SFVec3f ()),
				new X3DFieldDefinition (X3DConstants .inputOutput,    "motor3Axis",           new SFVec3f ()),
